...
class GuestsMeetingsAuthorizationsCommand(MultiTenantCommand):
    def __init__(self, client, guest_and_meeting_uuid):
        super(GuestsMeetingsAuthorizationsCommand, self).__init__(client)
...
class GuestsMeetingsRelation(object):
...
class GuestsMeetingsCommand(MultiTenantCommand):
    ...
    def __init__(self, client, guest_uuid):
        super(GuestsMeetingsCommand, self).__init__(client)
        self.guest_uuid = guest_uuid

    def relations(self, meeting_uuid):
        return super(GuestsMeetingsCommand, self).relations(
            (self.guest_uuid, meeting_uuid)
        )


class GuestsRelation(object):
